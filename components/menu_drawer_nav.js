...
class MenuDrawer extends Component{
  ...
  render(){
    ...
    console.log("after item selected final"+this.state.selectedMenuOption);

    if (this.state.selectedMenuOption == 'Home') {

      console.log("after item selected final final"+this.state.selectedMenuOption);
        mainView =  <HomeScreen title={this.state.selectedMenuOption}/>
    }
    else if (this.state.selectedMenuOption == 'Rooms') {
        mainView =  <Room title={this.state.selectedMenuOption}/>
        ...
        mainView =  <Facility title={this.state.selectedMenuOption}/>
    }else if(this.state.selectedMenuOption == 'Rates'){
        mainView =  <Rates title={this.state.selectedMenuOption}/>
    }else if(this.state.selectedMenuOption == 'Location'){
        mainView =  <LocationView title={this.state.selectedMenuOption}/>
    }else if(this.state.selectedMenuOption == 'Gallery'){
        mainView =  <Gallery title={this.state.selectedMenuOption}/>
    }else if(this.state.selectedMenuOption == 'Booking'){
        mainView =  <Booking title={this.state.selectedMenuOption}/>
    }else{
        mainView =  <MenuDrop title={this.state.selectedMenuOption}/>
    }
